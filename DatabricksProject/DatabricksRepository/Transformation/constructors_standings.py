...
# incrementalLoad(input_df=sorted_df, databaseName="f1_presentation", tableName="constructor_standings", partitionField="race_year")
...
mergeCondition = "target.team = source.team AND target.race_year = source.race_year"

incrementalLoadDelta(input_df=final_df, databaseName="f1_presentation", tableName="constructor_standings", 
...
display(spark.read.format("delta") \
                  .load(f"{presentation_folder_path}/constructor_standings"))
