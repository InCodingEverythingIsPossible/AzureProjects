...
df_raw_population = spark.read.csv("/mnt/covidreportingpwdl/raw/population", sep=r'\t', header=True)
...
df_raw_population_pivot = spark.sql("""SELECT country_code, 
                                            age_group, 
...
df_dim_country = spark.read.csv("/mnt/covidreportingpwdl/lookup/dim_country", sep=r',', header=True)
...
df_processed_population.write.format("com.databricks.spark.csv") \
                             .option("header","true") \
                             .option("delimiter", ",") \
                             .mode("overwrite") \
                             .save("/mnt/covidreportingpwdl/processed/population")
